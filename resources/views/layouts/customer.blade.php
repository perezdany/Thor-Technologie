...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="img/thor_logo.png" />
</head>
      ...
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
          <!--<a class="navbar-brand brand-logo" ><img src="img/logothor_tech.jpg" alt="logo"/></a>-->
           <a class="navbar-brand brand-logo" ><img src="img/thor_tech_1539x800.jpg" alt="logo"/></a>
          <a class="navbar-brand brand-logo-mini" ><img src="img/thor_logo.png" ></a>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
		  ...
		  <li class="nav-item">
            <a class="nav-link" href="our_products">
